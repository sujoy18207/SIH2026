...
export default function HeroLanding({ 
  ...
  const monitoredWorks = stats?.total_works || 0;
  const releasedExp = stats?.total_expenditure_amount
    ? (stats.total_expenditure_amount / 10000000).toLocaleString('en-IN', { maximumFractionDigits: 2 })
    : '0';
  const priorityRisks = (stats?.high_risk_works_count || 0) + (stats?.critical_risk_works_count || 0);
